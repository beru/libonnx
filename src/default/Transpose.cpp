...
void resolver_default_op_Transpose(struct onnx_node_t * n)
{
	if(n->opset >= 13)
	{
		...
		case ONNX_TENSOR_TYPE_BOOL:
			...
			n->ope = Transpose_bool;
			break;
		case ONNX_TENSOR_TYPE_INT8:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_int8;
			break;
		case ONNX_TENSOR_TYPE_INT16:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_int16;
			break;
		case ONNX_TENSOR_TYPE_INT32:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_int32;
			break;
		case ONNX_TENSOR_TYPE_INT64:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_int64;
			break;
		case ONNX_TENSOR_TYPE_UINT8:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_uint8;
			break;
		case ONNX_TENSOR_TYPE_UINT16:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_uint16;
			break;
		case ONNX_TENSOR_TYPE_UINT32:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_uint32;
			break;
		case ONNX_TENSOR_TYPE_UINT64:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_uint64;
			break;
		case ONNX_TENSOR_TYPE_BFLOAT16:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_bfloat16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT16:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_float16;
			break;
		case ONNX_TENSOR_TYPE_FLOAT32:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_float32;
			break;
		case ONNX_TENSOR_TYPE_FLOAT64:
			n->init = Transpose_init;
			n->exit = Transpose_exit;
			n->reshape = Transpose_reshape;
			n->ope = Transpose_float64;
			break;
