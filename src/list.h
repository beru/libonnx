 ...
 */
static inline void list_bulk_move_tail(list_head * head,
				       list_head * first,
				       list_head * last)
{
 ...
 */
static inline int list_is_first(const list_head * list,
...
static inline void __list_cut_position(list_head * list,
		list_head * head, list_head * entry)
{
 ...
 *
 */
static inline void list_cut_position(list_head * list,
		list_head * head, list_head * entry)
{
	if(list_empty(head))
		return;
 ...
 * @list.
 */
static inline void list_cut_before(list_head * list,
				   list_head * head,
				   list_head * entry)
{
	if (head->next == entry)
...
static inline void __list_splice(const list_head * list,
				 list_head * prev,
				 list_head * next)
{
 ...
 */
static inline void list_splice(const list_head * list,
				list_head * head)
{
	if(!list_empty(list))
 ...
 * @head: the place to add it in the first list.
 */
static inline void list_splice_tail(list_head * list,
				list_head * head)
{
	if(!list_empty(list))
 ...
 * The list at @list is reinitialised
 */
static inline void list_splice_tail_init(list_head * list,
					 list_head * head)
{
	if(!list_empty(list))
	{
...
#define list_first_entry_or_null(ptr, type, member) ({ \
	list_head * head__ = (ptr); \
	list_head * pos__ = head__->next; \
...
static inline void init_hlist_head(hlist_head * hlist)
{
	hlist->first = NULL;
}
...
static inline void hlist_add_fake(hlist_node * n)
{
	n->pprev = &n->next;
}

static inline int hlist_fake(hlist_node * h)
{
 ...
 * accessing head:
 */
static inline int hlist_is_singular_node(hlist_node * n, hlist_head * h)
{
